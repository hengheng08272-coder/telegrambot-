// MD5 of a KHQR payload — edge-runtime copy of src/lib/md5.ts.
//
// Duplicated rather than imported because edge functions are bundled on
// their own and cannot reach the Vite `@/` alias. Byte-for-byte the same
// algorithm, so the md5 khqr-issue stores and the md5 the browser would
// have computed for the same payload agree.
//
