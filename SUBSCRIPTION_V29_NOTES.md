...
1. **បន្ទាត់ចុចៗ (dotted leader)** នៅជួរ គម្រោង / វិធីទូទាត់ — ស្លាកឆ្វេង តម្លៃស្ដាំ
   ភ្ជាប់ដោយបន្ទាត់ចុចៗ ដូចសំបុត្រពិត។ វាធ្វើឲ្យជួរនីមួយៗអានជា "មួយបន្ទាត់"
   ជំនួសឲ្យ "ពីរវត្ថុនៅជិតគ្នា" ហើយឈ្មោះគម្រោងវែងក៏មិនអណ្ដែតដែរ។
   **ត្រូវបង់** ដាច់ចេញក្រោមបន្ទាត់ ជាមួយ `USD` តូចក្បែរលេខ (Anton 30px)
