...
export const theme = {
  colors: {
    ...
    accentDark: '#B98430',
    accentLight: '#FFE7B0',
    background: '#07080C', // page base
    backgroundDeep: '#04050A', // behind the base (scrims, sheets, letterbox)
  ...
  gradients: {
    ...
    // Ambient "aurora" wash painted behind every screen (see .bg-app).
    aurora:
      'radial-gradient(70% 48% at 12% -6%, rgba(255,45,70,0.16) 0%, rgba(7,8,12,0) 62%), radial-gradient(60% 42% at 92% 4%, rgba(76,111,255,0.14) 0%, rgba(7,8,12,0) 60%), radial-gradient(80% 55% at 50% 108%, rgba(245,197,99,0.07) 0%, rgba(7,8,12,0) 64%)',
  },
  fonts: {
