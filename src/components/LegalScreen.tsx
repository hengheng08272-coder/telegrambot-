...
export default function LegalScreen({ onBack }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#0A0605] text-white">
      <div className="sticky top-0 z-10 flex items-center gap-3 border-b border-white/10 bg-[#0A0605]/95 px-4 py-4 backdrop-blur-md sm:px-8">
        <button
          onClick={onBack}
        ...
        <div className="mb-6 flex gap-2">
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-bold transition ${
              tab === 'terms' ? 'bg-[#E31E24] text-white' : 'border border-white/10 bg-white/5 text-white/60'
            }`}
          >
          ...
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-bold transition ${
              tab === 'privacy' ? 'bg-[#E31E24] text-white' : 'border border-white/10 bg-white/5 text-white/60'
            }`}
          >
