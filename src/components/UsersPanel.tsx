                  ...
                  <div className="mt-2.5 space-y-2 rounded-lg border border-[#F5C563]/25 bg-[#F5C563]/[0.06] p-2.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex shrink-0 items-center gap-1 rounded-lg bg-gradient-to-r from-[#F5C563] to-[#B98430] px-3 py-2 text-[11px] font-bold text-[#0b0809] transition hover:brightness-110 disabled:opacity-40"
                      >
