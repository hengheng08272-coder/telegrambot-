    ...
    <div className="min-h-screen bg-app pb-10 text-white">
      ...
      <div className="px-4 py-6 fade-up">
          ...
          style={
            status?.subscribed
              ? {
                  ...
                  background:
                    'linear-gradient(120deg, rgba(245,197,99,0.14), rgba(11,8,9,0.4) 60%)',
        ...
        >
          {status?.subscribed && (
            <span
              className="absolute right-3 top-3 flex items-center gap-1 rounded-md px-2 py-0.5 text-[9.5px] font-black uppercase tracking-wider text-[#0b0809]"
        ...
        {bonusInfo && (
          ...
          >
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#2050D8] to-[#B98430]">
              <Gift className="h-5 w-5 text-[#0b0809]" />
            </div>
