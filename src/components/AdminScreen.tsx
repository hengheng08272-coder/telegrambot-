            ...
            {continuePostingShows.map((show) => {
              ...
              return (
                <button
                  ...
                  style={{ width: 220 }}
                >
                  <div className="h-14 w-10 shrink-0 overflow-hidden rounded-md bg-[#141416]">
                    {show.poster_url && (
          ...
          <div className="grid grid-cols-1 gap-2.5 lg:grid-cols-2">
            {filteredShows.map((show) => {
              ...
              return (
                ...
                >
                  <div className="h-20 w-14 shrink-0 overflow-hidden rounded-lg bg-[#141416]">
                    {show.poster_url && (
                      <img src={show.poster_url} alt={show.title} className="h-full w-full object-cover" />
                    )}
                  </div>
        ...
        <div className="fixed inset-0 z-[80] flex flex-col bg-app">
          <header className="sticky top-0 z-10 shrink-0 border-b border-white/10 bar-blur">
            <div className="mx-auto flex max-w-[1100px] items-center gap-3 px-4 py-3.5 sm:px-8">
              ...
              <div className="h-10 w-7 shrink-0 overflow-hidden rounded-md bg-[#141416]">
            ...
            <div className="space-y-3">
              {focusedShow.episodes.map((ep) => {
                ...
                return (
                  <div
                    key={ep.id}
                    className="rounded-xl border border-white/5 bg-[#141416] p-3"
                  >
            ...
            {(focusedShow.type !== 'movie' || focusedShow.episodes.length === 0) && (
              <div className="mt-4">
                {addEpOpen === focusedShow.id ? (
                  <div className="space-y-3 rounded-xl border border-white/10 bg-[#141416] p-4">
