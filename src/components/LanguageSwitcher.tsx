  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`rounded-md px-2 py-1 text-[11px] font-semibold leading-[1.45] transition font-khmer ${
      ...
      <button
        ...
        className={`rounded-md px-2 py-1 text-[11px] font-semibold leading-[1.45] transition ${
