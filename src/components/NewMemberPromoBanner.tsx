    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      ...
      <div className="promo-card-glow relative w-full max-w-sm rounded-3xl">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-[#171725] to-[#0A0605] p-6 text-center shadow-[0_0_70px_rgba(255,201,74,0.2)]">
          ...
          <Sparkles className="sparkle-twinkle pointer-events-none absolute left-5 top-14 h-3.5 w-3.5 text-[#FFC94A]/50" />
          <Sparkles
            className="sparkle-twinkle pointer-events-none absolute right-8 top-24 h-2.5 w-2.5 text-[#E31E24]/60"
            style={{ animationDelay: '0.5s' }}
          />
          <Sparkles
            className="sparkle-twinkle pointer-events-none absolute left-10 bottom-24 h-2.5 w-2.5 text-[#FFC94A]/40"
          ...
          <div className="relative mx-auto mb-4 flex h-20 w-20 items-center justify-center">
            <div className="absolute inset-0 rounded-full bg-[#FFC94A]/35 blur-xl" />
            <div className="absolute inset-0 rounded-full animate-glow-pulse" />
            <div className="gift-float relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#FFC94A] to-[#B8862E] shadow-lg ring-4 ring-[#FFC94A]/20">
              <Gift className="h-9 w-9 text-[#0A0605]" />
            </div>
          </div>

          <div className="mx-auto mb-3 inline-flex items-center gap-1.5 rounded-full border border-[#FFC94A]/30 bg-[#FFC94A]/10 px-3 py-1">
            <Sparkles className="h-3 w-3 text-[#FFC94A]" />
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#FFC94A]">
              {t.promoEyebrow}
            </span>
            <Sparkles className="h-3 w-3 text-[#FFC94A]" />
          </div>
          ...
          <button
            onClick={onPrimary}
            className="group flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#FFC94A] to-[#B8862E] py-3.5 text-sm font-bold text-[#0A0605] shadow-[0_8px_24px_rgba(255,201,74,0.35)] transition hover:scale-[1.02] hover:shadow-[0_10px_30px_rgba(255,201,74,0.5)] active:scale-[0.98]"
          >
