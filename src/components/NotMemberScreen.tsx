...
export default function NotMemberScreen({ groupLink }: Props) {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#0A0605] px-6 text-center text-white">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#E31E24]/10">
      ...
      {groupLink && (
        <a
          href={groupLink}
          className="rounded-full bg-gradient-to-r from-[#E31E24] to-[#8C0F12] px-6 py-2.5 text-sm font-bold text-white transition active:scale-95"
        >
          ចូលរួម VIP Group
        </a>
      )}
