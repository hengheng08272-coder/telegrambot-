  ...
  return (
    <div className="fixed inset-0 z-[95] flex flex-col bg-app-deep">
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 90% 40% at 50% -5%, rgba(230,35,31,0.14) 0%, rgba(4,5,10,0) 62%)',
        }}
      />
      ...
      <main className="relative z-10 flex-1 overflow-y-auto px-4 pb-6">
        {phase === 'loading' ? (
          ...
          <div className="space-y-4 pb-2">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-[#E6231F]/20 bg-white/[0.03] p-4 text-center">
              ...
              {abaDeeplink && (
                <a
                  ...
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#E6231F] to-[#8F1020] py-3 text-sm font-bold text-white shadow-[0_8px_20px_-8px_rgba(230,35,31,0.75)] transition active:scale-[0.98]"
                >
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4">
              ...
              {proofPreviewUrl ? (
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-white/15 bg-white/[0.02] py-4 text-sm font-semibold text-white/60 transition hover:border-[#E6231F]/40 hover:text-white"
                >
