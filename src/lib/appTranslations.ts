export const appText = {
  en: {
    ...
    subMethodAbaTitle: 'Pay with ABA',
    subMethodAbaDesc: 'Open the ABA app directly, auto-verified',
    subMethodOtherTitle: 'Other Bank (QR)',
    subMethodOtherDesc: 'Scan the QR from any banking app, upload receipt',
  ...
  km: {
    ...
    subMethodAbaTitle: 'ទូទាត់តាម ABA',
    subMethodAbaDesc: 'បើក App ABA ដោយផ្ទាល់ ផ្ទៀងផ្ទាត់ស្វ័យប្រវត្តិ',
    subMethodOtherTitle: 'ធនាគារផ្សេងទៀត (QR)',
