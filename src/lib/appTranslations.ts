export const appText = {
  en: {
    ...
    subCopyPayLink: "Didn't open? Copy the link",
    subPayLinkCopied: 'Link copied — paste it in Safari or Chrome',
  ...
  km: {
    ...
    subCopyPayLink: 'មិនបើកទេ? ចម្លង link',
    subPayLinkCopied: 'ចម្លងរួច — សូម paste ក្នុង Safari ឬ Chrome',
