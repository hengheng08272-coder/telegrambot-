export const appText = {
  en: {
    ...
    subJoinVip: 'Select Payment',
    subJoinVipNote: 'Choose how you\u2019d like to pay next',
    subSelectMethodTitle: 'Select payment method',
    subSelectMethodDesc: 'Choose how you\u2019d like to pay for this plan',
    subMethodAba: 'Pay with ABA',
    subMethodAbaDesc: 'Scan the QR, then upload your receipt to confirm',
    subMethodQr: 'QR — other banks',
    subMethodQrDesc: 'Scan with any KHQR banking app and upload your receipt',
    subAbaScreenshotNote:
      'After you finish paying in ABA Mobile, come back here and upload a screenshot of your receipt so we can verify it.',
    subExitConfirmTitle: 'Leave this payment?',
    subExitConfirmBody:
      'Your payment ticket is still open. Do you want to keep paying, or exit for now?',
    subExitConfirmContinue: 'Continue Paying',
  ...
  km: {
    ...
    subJoinVip: 'ជ្រើសរើសការទូទាត់',
    subJoinVipNote: 'ជ្រើសរើសវិធីទូទាត់ដែលអ្នកចង់ប្រើ',
    subSelectMethodTitle: 'ជ្រើសរើសវិធីទូទាត់',
    subSelectMethodDesc: 'សូមជ្រើសរើសវិធីដែលអ្នកចង់ទូទាត់សម្រាប់គម្រោងនេះ',
    subMethodAba: 'ទូទាត់ជាមួយ ABA',
    subMethodAbaDesc: 'ស្កេន QR រួចបញ្ចូលរូបភាពវិក្កយបត្រ ដើម្បីបញ្ជាក់ការទូទាត់',
    subMethodQr: 'QR — ធនាគារផ្សេងទៀត',
    subMethodQrDesc: 'ស្កេនជាមួយកម្មវិធីធនាគារ KHQR ណាមួយ រួចបញ្ចូលរូបភាពវិក្កយបត្រ',
    subAbaScreenshotNote:
      'បន្ទាប់ពីទូទាត់រួចរាល់តាមរយៈ ABA Mobile សូមត្រឡប់មកទីនេះវិញ ហើយបញ្ចូលរូបភាព screenshot នៃវិក្កយបត្រ ដើម្បីធ្វើការផ្ទៀងផ្ទាត់។',
    subExitConfirmTitle: 'ចាកចេញពីការទូទាត់នេះ?',
    subExitConfirmBody:
      'សំបុត្រទូទាត់របស់អ្នកនៅតែបើកនៅឡើយ។ តើអ្នកចង់បន្តទូទាត់ ឬ ចាកចេញសិន?',
