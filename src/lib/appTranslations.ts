export const appText = {
  ...
  km: {
    ...
    recommendedForYou: 'ស័ក្តិសមសម្រាប់អ្នក',
    startWatching: 'ចាប់ផ្តើមមើល',
    buyMovie: 'ទិញភាពយន្ត',
    buyThisMovie: 'ទិញភាពយន្តនេះ',
    movieUnlockedTitle: 'បានដោះសោ!',
    movieUnlockedDesc: 'ភាពយន្តនេះឥឡូវជារបស់អ្នកសម្រាប់ទស្សនា។',
    movieUploadReceipt: 'បង់ថ្លៃរួចហើយ? ភ្ជាប់វិក្កយបត្រដើម្បីដោះសោភ្លាមៗ។',
    movieConfirmPay: 'បញ្ជាក់ការទូទាត់',
    movieChangeScreenshot: 'ប្តូរ',
